...
public class OrderStateHorizaontalScrollView extends HorizontalScrollView {
	...
	public OrderStateHorizaontalScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public OrderStateHorizaontalScrollView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setImageData(List<CommentPicData> picDatas) {
		...
		} else if (imageListGroup.getChildCount() > 0)
			return; // 防止多次加载
	...
	public int getImageCount() {
		if (imageListGroup == null)
			...
			return imageListGroup.getChildCount();
	}
