...
public class TimePanel extends LinearLayout {

    private static final String TAG = TimePanel.class.getName();
    ...
    public static interface OnPanelListener {
         ...
         */
        public void onPanelClosed(TimePanel panel);
        /**
         * Invoked when the panel becomes fully opened.
         */
        public void onPanelOpened(TimePanel panel);
    }
...
//			Log.d(TAG, "state: " + mState + " x: " + event.getX() + " y: " + event.getY());
	...
	private void postProcess() {
		...
		if (panelListener != null) {
			if (mIsShrinking) {
				panelListener.onPanelClosed(TimePanel.this);
			} else {
				panelListener.onPanelOpened(TimePanel.this);
			}
		}
	}
