...
//		returnToActivity(Settings.mdbActivityClazz);
		super.finish();
	}
	...
	private void initComponent() {
		...
		group_buy_order_bt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				bundle.putString(Settings.BUNDLE_REST_ID, restId);
	...
	private void executeOrderSubmitSuccess() {
		ServiceRequest request = new ServiceRequest(API.getMdbFreeOrderState);
			...
			protected void onSuccess(CommonOrderStateData dto) {
				...
				try {
					if (dto != null && dto.succTag) {
						...
						MdbSubmitSuccessActivity.this.getBtnGoBack().setVisibility(View.VISIBLE);;
					} else {
						MdbSubmitSuccessActivity.this.getBtnGoBack().setVisibility(View.GONE);;
						group_buy_msg.setText(dto.msg);
						group_buy_title.setText(dto.title);
						group_buy_icon_url.setImageByUrl(dto.iconUrl, true, 0, ScaleType.FIT_XY);
